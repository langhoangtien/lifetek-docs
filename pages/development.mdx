...
- `DATABASE_TYPE`: The database type. Options: `oracle`,`mysql`,`postgres`.
...
To run additional services like the database, mail server, apex, etc., use the `docker-compose` command:
...
> Note: The application will run on port 3000 [Localhost](http://localhost:3000)
