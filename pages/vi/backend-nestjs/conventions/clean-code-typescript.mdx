...
Các khái niệm Clean Code được điều chỉnh cho TypeScript.
Cảm hứng từ [clean-code-javascript](https://github.com/ryanmcdermott/clean-code-javascript).
...
11. [Bình luận](#bình-luận)
12. [Dịch](#dịch)

## Giới thiệu

![Hình ảnh hài hước về việc ước lượng chất lượng phần mềm qua số lượng câu chửi khi đọc mã nguồn](https://www.osnews.com/images/comics/wtfm.jpg)

Các nguyên lý kỹ thuật phần mềm từ cuốn sách của Robert C. Martin _Clean Code_, được điều chỉnh cho TypeScript. Đây không phải là hướng dẫn phong cách. Nó là một hướng dẫn để sản xuất phần mềm [đọc được, tái sử dụng được và dễ dàng refactor](https://github.com/ryanmcdermott/3rs-of-software-architecture) trong TypeScript.

Không phải tất cả các nguyên lý trong đây đều phải được tuân theo một cách nghiêm ngặt, và càng ít hơn nữa là có thể có sự đồng thuận toàn cầu. Đây chỉ là những hướng dẫn, nhưng chúng đã được mã hóa qua nhiều năm kinh nghiệm của các tác giả cuốn _Clean Code_.

Nghề kỹ thuật phần mềm chỉ mới hơn 50 năm tuổi, và chúng ta vẫn còn học hỏi rất nhiều. Khi kiến trúc phần mềm có tuổi thọ bằng kiến trúc xây dựng, có lẽ lúc đó chúng ta sẽ có những quy tắc cứng nhắc hơn để tuân theo. Còn hiện tại, hãy để những hướng dẫn này là một công cụ để đánh giá chất lượng mã nguồn TypeScript mà bạn và nhóm của bạn sản xuất.

Một điều nữa: biết những nguyên lý này sẽ không lập tức làm bạn trở thành một lập trình viên giỏi hơn, và việc làm việc với chúng suốt nhiều năm không có nghĩa là bạn sẽ không mắc phải sai lầm. Mỗi đoạn mã đều bắt đầu là bản nháp đầu tiên, như đất sét ướt được tạo hình thành dạng cuối cùng. Cuối cùng, chúng ta sẽ gọt dũa những khiếm khuyết khi xem xét mã với đồng nghiệp. Đừng tự trách mình vì những bản nháp đầu tiên cần cải thiện. Hãy "đánh đập" mã thay vì đánh đập chính mình!

**[⬆ quay lại đầu mục](#mục-lục)**

## Biến

### Sử dụng tên biến có ý nghĩa

Phân biệt các tên sao cho người đọc biết được sự khác biệt giữa chúng.
...
### Sử dụng tên biến có thể phát âm được

Nếu bạn không thể phát âm được tên, bạn sẽ không thể thảo luận về nó mà không nghe như một kẻ ngốc.
...
### Sử dụng cùng một từ vựng cho cùng loại biến
...
Chúng ta sẽ đọc mã nhiều hơn là viết nó. Điều quan trọng là mã chúng ta viết phải dễ đọc và dễ tìm kiếm. Nếu bạn không đặt tên biến sao cho dễ hiểu, bạn đang làm hại người đọc. Hãy để tên biến có thể tìm kiếm được. Các công cụ như [ESLint](https://typescript-eslint.io/) có thể giúp nhận diện các hằng số không tên (còn gọi là chuỗi ma thuật hoặc số ma thuật).
...
```ts
// Khai báo chúng như các hằng số với tên rõ ràng
...
### Tránh Mapping Tâm Lý

Rõ ràng luôn tốt hơn ngầm hiểu.
_Rõ ràng là vua._
...
Nếu tên lớp/kiểu/đối tượng của bạn đã nói rõ điều gì đó, đừng lặp lại điều đó trong tên biến.
...
### Sử dụng tham số mặc định thay vì sử dụng điều kiện hoặc ngắt mạch

Các tham số mặc định thường sạch sẽ hơn so với việc ngắt mạch.
...
### Sử dụng enum để ghi lại ý định

Enum có thể giúp bạn ghi lại ý định của mã. Ví dụ, khi bạn quan tâm đến việc các giá trị khác nhau thay vì giá trị chính xác của chúng.
...
If you are looking for help in migrating from TSLint to ESLint, you can check out this project: [tslint-to-eslint-config](https://github.com/typescript-eslint/tslint-to-eslint-config).
